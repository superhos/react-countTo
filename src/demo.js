        ...
        return <div className={'demo'}>
           ...
           <div className={'sample'}>
                ...
                <div className={'control'}>
                    ...
                    <label>prefix: <input value={prefix} onChange={(val) => this.setState({ endVal: +val.currentTarget.value})}/></label>
                    <label>suffix: <input value={suffix} onChange={(val) => this.setState({ endVal: +val.currentTarget.value})}/></label>
